...
require 'offsite_payments_przelewy24'

OffsitePaymentsPrzelewy24.mode = :test
...
module OffsitePaymentsPrzelewy24
  module Assertions
    ...
    def assert_deprecation_warning(message)
      OffsitePaymentsPrzelewy24.expects(:deprecated).with(message)
      yield
    end

    def silence_deprecation_warnings
      OffsitePaymentsPrzelewy24.stubs(:deprecated)
      yield
    end

    def assert_no_deprecation_warning
      OffsitePaymentsPrzelewy24.expects(:deprecated).never
      yield
    end
...
Test::Unit::TestCase.class_eval do
  include OffsitePaymentsPrzelewy24
  # include OffsitePaymentsPrzelewy24::Assertions
  # include OffsitePaymentsPrzelewy24::Fixtures
end

module ActionViewHelperTestHelper
  def self.included(base)
    base.send(:include, OffsitePaymentsPrzelewy24::ActionViewHelper)
